...
<head>
	...
	<title>ශ්‍රී හර්දයේ සමිතිය</title>
	...
	<div class = "wrapper">
		...
		<div class="intro">
			<div class="intro_txt" style="background-image: url(../../img/society/intro.jpg);">
				<h1 class="sinhala">ශ්‍රී හර්දයේ සමිතිය</h1>
			</div><!-- intro_txt -->
		</div><!-- intro -->
		...
		<div class="all_society sinhala">
			<div class="society_list">
				<ul>
					...
					<li><a href="darmaduthasamithiya.php">ධර්මදුත ළමා සමාජය</a></li>
			...
			<div class="description">
				...
				<p><?php include("../../Data/society/dhs.txt") ?></p>
				
			</div><!-- description -->
		</div><!-- all_society -->
		<p class="note"><a href="edit-society.php?id=dhs">Click here to edit above text</a></p>
		<div class="free_area">

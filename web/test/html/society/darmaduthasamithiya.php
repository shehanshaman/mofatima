	...
	<div class = "wrapper">
		...
		<div class="intro">
			<div class="intro_txt" style="background-image: url(../../img/society/intro.jpg);">
				<h1 class="sinhala">ධර්මදුත ළමා සමාජය</h1>
			</div><!-- intro_txt -->
		</div><!-- intro -->
		...
		<div class="all_society sinhala">
			...
			<div class="description">
				...
				<p><?php include("../../Data/society/ds.txt") ?></p>
				
			</div><!-- description -->
		</div><!-- all_society -->
		<p class="note"><a href="edit-society.php?id=ds">Click here to edit above text</a></p>
		<div class="free_area">
